...
public class GetUserAndOwnerBookingTest {
    ...
    @BeforeEach
    public void setUp() {
        owner1 = new User(null, "user1", "user1@mail.com");
        owner2 = new User(null, "user2", "user2@mail.com");
        booker = new User(null, "booker1", "booker1@mail.com");
        bookerWithoutBookings = new User(null, "booker2", "booker2@mail.com");
