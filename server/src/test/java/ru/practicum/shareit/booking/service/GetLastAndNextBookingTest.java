...
public class GetLastAndNextBookingTest {
    ...
    @BeforeEach
    public void setUp() {
        User owner = new User(null, "user1", "user1@mail.com");
        User booker = new User(null, "booker1", "booker1@mail.com");
        userRepository.saveAll(List.of(owner, booker));

        itemWithBookings = new Item(null, "item with bookings", "item 1", true, owner, null);
        itemWithoutLastBookings = new Item(null, "item without last booking", "item 2", true, owner, null);
        itemWithoutNextBookings = new Item(null, "item without next booking", "item 3", true, owner, null);
        itemWithoutBookings = new Item(null, "item without bookings", "item 4", true, owner, null);
