...
public class BookingServiceTest {
    ...
    @BeforeEach
    public void setUp() {
        u1 = User.builder().name("User 1").email("user1@gmail.com").build();
        u2 = User.builder().name("User 2").email("user2@gmail.com").build();
        i1 = Item.builder()
                .name("Item 1")
    ...
    public void shouldGetBooking() {
        ...
        Booking booking = Booking.builder()
                ...
                .status(Status.APPROVED).build();
        bookingService.saveBooking(booking);
        User user = User.builder().name("New User").email("newUser@mail.ru").build();
