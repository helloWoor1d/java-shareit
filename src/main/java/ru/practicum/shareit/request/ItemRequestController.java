...
public class ItemRequestController {
    ...
    @PostMapping
    public ResponseEntity<ItemRequestGetDto> createRequest(@RequestHeader("X-Sharer-User-Id") long userId,
    ...
    @GetMapping
    public ResponseEntity<List<ItemRequestGetDto>> getUserRequests(@RequestHeader("X-Sharer-User-Id") long userId) {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ItemRequestGetDto>> getAllRequests(@RequestHeader("X-Sharer-User-Id") long userId,
    ...
    public ResponseEntity<ItemRequestGetDto> getRequest(@RequestHeader("X-Sharer-User-Id") long userId,
