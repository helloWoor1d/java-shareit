...
public class BookingController {
    ...
    @GetMapping
    public ResponseEntity<List<BookingGetDto>> getUserBookings(@RequestHeader("X-Sharer-User-Id") long userId,
    ...
    @GetMapping("/owner")
    public ResponseEntity<List<BookingGetDto>> getOwnerBookings(@RequestHeader("X-Sharer-User-Id") long userId,
                                                                   @RequestParam(defaultValue = "ALL") String state) {
        try {
